    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-4 gap-5 mb-6">
        {[
          ...
          <Link key={label} href={href}
            className="rounded-xl border border-borde bg-white p-6 hover:shadow-md hover:border-gray-300 transition-all duration-200 group">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={label} className="rounded-xl border border-borde bg-white p-5 flex items-center justify-between">
      ...
      <div className="grid grid-cols-5 gap-3 mb-8">
        {(['recibido', 'en_analisis', 'propuesta_lista', 'enviada', 'cliente_interesado'] as const).map(estado => (
          <div key={estado} className="rounded-xl border border-borde bg-white p-5">
