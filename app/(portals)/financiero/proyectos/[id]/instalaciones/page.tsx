...
export default async function FinancieroInstalacionesPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Verify access: project must have this financiero assigned
  ...
  return (
    <div className="py-6 px-4">
      <div className="max-w-5xl mx-auto mb-6">
        ...
        <p className="text-xs text-gray-500 mt-0.5">Seguimiento de Instalación (Financiamiento)</p>
      </div>
