...
export default function AnalistaClientesPage() {
      ...
      <div className="rounded-xl border border-borde overflow-hidden bg-white shadow-sm">
        <table className="w-full text-sm text-left">
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {lista.map(c => (
              <tr key={c.id} className="hover:bg-gray-50/50 transition-colors cursor-pointer" onClick={() => window.location.href = `/analista/clientes/${c.id}`}>
